...
export const mockHotels: HotelType[] = [
  {
    ...
    photos: [
      { url: 'https://picsum.photos/id/1031/800/400', isPrimary: true },
      { url: 'https://picsum.photos/id/1039/800/400', isPrimary: false },
      { url: 'https://picsum.photos/id/1040/800/400', isPrimary: false },
    ],
  ...
  },
  {
    ...
    openingDate: '2026-02-17',
    photos: [
      { url: 'https://picsum.photos/id/1048/800/400', isPrimary: true },
      { url: 'https://picsum.photos/id/1054/800/400', isPrimary: false },
    ],
    amenities: ['WiFi', 'Family', 'Pool'],
    status: 'approved',
    rejectReason: '',
    isActive: true,
    isDeleted: false,
  ...
  },
  {
    ...
    openingDate: '2026-02-17',
    photos: [
      { url: 'https://picsum.photos/id/1067/800/400', isPrimary: true },
      { url: 'https://picsum.photos/id/1069/800/400', isPrimary: false },
    ],
    amenities: ['WiFi', 'Parking', 'Pets', 'Airport'],
    status: 'approved',
    rejectReason: '',
    isActive: true,
    isDeleted: false,
